#!/usr/bin/env python3
"""Run Card-Krueger verification when the DiD analysis script is edited (Claude Code PostToolUse hook)."""
...
def main() -> int:
    ...
    edited_path = str(tool_input.get("file_path") or tool_input.get("path") or "")
