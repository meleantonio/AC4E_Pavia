...
description: >
  Reviews bibliography completeness, citation–reference consistency, and research-claim
  accuracy for the Card-Krueger minimum-wage literature. Use after drafting a paper
  section, updating references.bib, or when reviewing a diff that touches citations or
  literature notes. Use proactively when the user mentions bibliography, citations, or
  overclaiming.
model: inherit
readonly: true
---
